...
#. Enter search criteria in the search box by referring to :ref:`Using Search Syntax <lts_05_0111>` to view, search, and filter log data.
   ...
   b. In the search area, press the up and down arrows on the keyboard to select a keyword or search syntax from the drop-down list, press **Tab** to select a keyword or syntax, and click **Search**.

   c. Click a field for which quick analysis has been enabled to add it to the search box. For details about how to enable quick analysis, see :ref:`Creating a Quick Analysis Task <lts_05_0007>`.
...
#. Set the layout of log data, including whether to display fields or display fields in a simple view.
   ...
   b. On the displayed **Layout** page, click **+** under **Layout List** to create a custom layout, name it, and configure how fields are displayed in this layout.

      You can perform the following operations on a new layout:

      -  Edit: Click |image1| to edit the layout's display name.
      -  Delete: Click |image2| and then **Yes** to delete the layout.
...
.. table:: **Table 1** Common operations
   ...
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Creating a quick search           | Click |image3| to create a quick search.                                                                                                                                                                                                                                     |
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Sharing logs                      | Click |image4| to copy the link of the current log search page to share the logs that you have searched.                                                                                                                                                                     |
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Refreshing logs                   | You can click |image5| to refresh logs in two modes: manual refresh and automatic refresh.                                                                                                                                                                                   |
   |                                   |                                                                                                                                                                                                                                                                              |
   ...
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Copying logs                      | Click |image6| to copy the log content.                                                                                                                                                                                                                                      |
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Viewing context of a log          | Click |image7| to view the log context.                                                                                                                                                                                                                                      |
   |                                   |                                                                                                                                                                                                                                                                              |
   |                                   | You can select **Simple View** to view the log context. You can also download the context.                                                                                                                                                                                   |
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | More operations                   | Click |image8| to access the log details page of the time segment and view more log information.                                                                                                                                                                             |
   |                                   |                                                                                                                                                                                                                                                                              |
   ...
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Unfold/Fold                       | Click |image9| to display all the log content. This unfold button is enabled by default. Click |image10| to fold the log content.                                                                                                                                            |
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Downloading logs                  | Click |image11|. On the displayed **Download Logs** page, click **Direct Download** or **Transfer and Download**.                                                                                                                                                            |
   |                                   |                                                                                                                                                                                                                                                                              |
   ...
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Hiding/Expanding all              | Click |image12| to set the number of lines displayed in the log content. Click |image13| to hide the log content.                                                                                                                                                            |
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | JSON                              | Move the cursor over |image14|, click **JSON**, and set JSON formatting.                                                                                                                                                                                                     |
   |                                   |                                                                                                                                                                                                                                                                              |
   ...
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Collapse configuration            | Move the cursor over |image15|, click **Log Collapse**, and set the maximum characters to display in a log.                                                                                                                                                                  |
   |                                   |                                                                                                                                                                                                                                                                              |
   ...
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Log time display                  | Move the cursor over |image16| and click **Log Time Display**. On the page that is displayed, set whether to display milliseconds and whether to display the time zone. Milliseconds are displayed by default.                                                               |
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Virtual Scrolling                 | Move the cursor over |image17| and click **Virtual Scrolling**. On the page that is displayed, set whether to enable virtual scrolling and enter the buffer size.                                                                                                            |
   |                                   |                                                                                                                                                                                                                                                                              |
   ...
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Invisible fields (|image18|)      | This list displays the invisible fields configured in the layout settings.                                                                                                                                                                                                   |
   |                                   |                                                                                                                                                                                                                                                                              |
   |                                   | -  The |image19| button is unavailable for log streams without layout settings configured.                                                                                                                                                                                   |
...
.. |image1| image:: /_static/images/en-us_image_0000002411002378.png
.. |image2| image:: /_static/images/en-us_image_0000002411162230.png
.. |image3| image:: /_static/images/en-us_image_0000001561940610.png
.. |image4| image:: /_static/images/en-us_image_0000001421609924.png
.. |image5| image:: /_static/images/en-us_image_0000001481236306.png
.. |image6| image:: /_static/images/en-us_image_0000001262546024.png
.. |image7| image:: /_static/images/en-us_image_0000001262546228.png
.. |image8| image:: /_static/images/en-us_image_0000002018849674.png
.. |image9| image:: /_static/images/en-us_image_0000001611940613.png
.. |image10| image:: /_static/images/en-us_image_0000001612061257.png
.. |image11| image:: /_static/images/en-us_image_0000001474530441.png
.. |image12| image:: /_static/images/en-us_image_0000001612024421.png
.. |image13| image:: /_static/images/en-us_image_0000001611907193.png
.. |image14| image:: /_static/images/en-us_image_0000001410398388.png
.. |image15| image:: /_static/images/en-us_image_0000001608069337.png
.. |image16| image:: /_static/images/en-us_image_0000001674961080.png
.. |image17| image:: /_static/images/en-us_image_0000001809715517.png
.. |image18| image:: /_static/images/en-us_image_0000001316788136.png
.. |image19| image:: /_static/images/en-us_image_0000001320576858.png

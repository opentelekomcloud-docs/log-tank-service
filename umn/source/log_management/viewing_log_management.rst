...
#. View the resource statistics of **Log Groups (Top 100)** and **Log Streams (Top 100)**. You can select a time range and view the daily read/write traffic (GB), daily index traffic - standard (GB), and daily standard storage volume (GB) of this period in tables or bar charts.
...
-  The **Latest Alarms** area displays a maximum of three latest alarm rules in the last 30 minutes.
-  To check more alarms, click **More** > **More**.
-  To add alarm rules, click **More** > **Add Rule**.

Log Groups
----------

Log groups and log streams are listed under **Log Groups**. For more information, see :ref:`Managing Log Groups <lts_04_0003>` and :ref:`Managing Log Streams <lts_04_0004>`.
...
-  **My Favorites**: Save log streams to the LTS database. This function is disabled by default. If your account has the write permission, **My Favorites** and **My Favorites(Local Cache)** are displayed.

-  **My Favorites(Local Cache)**: Save log streams to the local cache of the browser. This function is disabled by default. After you clear the browser history, your favorites will be deleted. This parameter is displayed for both writable and read-only users.
...
#. In the **Log Groups** list, click |image2| on the left of log group **lts-test**.
...
.. |image1| image:: /_static/images/en-us_image_0000002444746482.png
.. |image2| image:: /_static/images/en-us_image_0000001924750582.png

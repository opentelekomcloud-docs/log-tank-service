...
A message template defines the format of alarm notification messages sent to subscribers. LTS provides built-in message templates. Subscribers can select templates based on protocols. If the template of a specific protocol does not exist, use a custom template. When using a message template to send alarm notification messages, the system automatically replaces the template variables with the content in the alarm rule.

.. _lts_06_0011__en-us_topic_0000001159394194_section131581114132914:
...
#. Click **Create** on the **Message Templates** tab page. On the displayed page, set the required parameters.
   ...
   .. table:: **Table 1** Message template parameters
      ...
      +=====================+=================================================+========================================================================================================================================================================================================================================+===================+
      | Template Name       | Message template name.                          | Use only digits, letters, underscores (_), and hyphens (-). Do not start or end with an underscore or hyphen. Enter up to 100 characters.                                                                                              | LTS-test          |
      +---------------------+-------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------+
      | Description         | Description of the template.                    | Use only digits, letters, and underscores (_). Do not start or end with an underscore. Enter up to 1,024 characters.                                                                                                                   | ``-``             |
      +---------------------+-------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------+
...
#. In the message template list, click **Copy** in the row that contains the desired template. On the displayed page, set message template parameters by referring to :ref:`Creating a Message Template <lts_06_0011__en-us_topic_0000001159394194_section131581114132914>`.
#. Click **OK**.
